"""
Django settings for RefOne project.
...
# Create TEMPLATE_DIR variable storing path to 'templates' directory
TEMPLATE_DIR = os.path.join(BASE_DIR, 'templates')

# Create STATIC_DIR variable storing path to 'static' directory
STATIC_DIR = os.path.join(BASE_DIR, "static")

# Create MEDIA_DIR variable storing path to 'media' directory
...
SECRET_KEY = 'l7eia-xs7pg(le&hk$i*gqs$joj2mr_p0u!e7=)9$9#4=zwf4j'
...
WSGI_APPLICATION = 'RefOne.wsgi.application'
